...
{
    internal class DIRModule_FoodWastePerDestination_Dashboard_GridConfigurationRepository : BaseConfigurationRepository<HtmlGridConfiguration>, ICoreHtmlGridConfigurationRepository
    {
        public string GridName => GridNames.FOOD_WASTE_PER_DESTINATION_DASHBOARD;
        ...
        private HtmlGridConfiguration Version_3_9_0(HtmlGridConfiguration config)
        {
            ...
            config.HtmlGridData.WithColumn("Title")
                .SetConverter($"{DIRModuleInfo.Instance.ModuleName}.LegendValueConverter")
                .SetLabel("@DIR_AssessmentManager.FoodWastePerDestinationGridColumn_Title")
                .SetTargetProperties(new string[] { "Title", "LegendColor" })
                .SetType("String")
                .SetWidth(400);
