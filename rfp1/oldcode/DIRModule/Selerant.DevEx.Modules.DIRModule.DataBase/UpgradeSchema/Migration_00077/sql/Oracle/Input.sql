...
CREATE OR REPLACE PACKAGE BODY DXDIR_PK_INPUT AS
    ...
    BEGIN
		...
		-- Remove Non-Food rows when there aren't any COST or WEIGHT calculated from destionas
		--BEGIN
		--	SELECT CASE 
		...
		--	  DESTINATION_CODE         = sDESTINATION_CODE;
		--END IF;
		-- end Remove Non-Food rows when there aren't any COST or WEIGHT calculated from destionas
