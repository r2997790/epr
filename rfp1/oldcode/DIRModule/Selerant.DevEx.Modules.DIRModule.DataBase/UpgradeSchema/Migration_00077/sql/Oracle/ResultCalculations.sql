...
CREATE OR REPLACE PACKAGE BODY DXDIR_PK_RESULTCALCULATIONS AS 
	...
	IS
		...
		coProduct_OutputCategoryId NUMBER(11, 0) := 2;
		foodRescue_OutputCategoryId NUMBER(11, 0) := 3;
	BEGIN
		DXDIR_PK_CALCULATIONS.GetMargin(sASSESSMENT_CODE, dcASSESSMENT_LC_STAGE_ID, coProduct_OutputCategoryId, coProductMargin);
		DXDIR_PK_CALCULATIONS.GetMargin(sASSESSMENT_CODE, dcASSESSMENT_LC_STAGE_ID, foodRescue_OutputCategoryId, foodRescueMargin);
		...
		WHERE ASSESSMENT_CODE		 = sASSESSMENT_CODE AND 
			  ASSESSMENT_LC_STAGE_ID = dcASSESSMENT_LC_STAGE_ID AND 
			  OUTPUT_CATEGORY_ID = coProduct_OutputCategoryId;
		...
		WHERE ASSESSMENT_CODE = sASSESSMENT_CODE AND 
			  ASSESSMENT_LC_STAGE_ID = dcASSESSMENT_LC_STAGE_ID AND 
			  OUTPUT_CATEGORY_ID = foodRescue_OutputCategoryId;
