...
namespace Selerant.DevEx.Modules.DIRModule.BackEnd.InputManagement
{
	...
	public partial class DxFoodInputDestination : DxObject, IInputDestination
	{
		#region Fields
		...
		public DxFoodInputDestination() : base()
		{
		}

		public DxFoodInputDestination(decimal inputId, decimal outputCategoryId) : this(inputId, outputCategoryId, false)
		{
		}

		public DxFoodInputDestination(decimal inputId, decimal outputCategoryId, bool load) : this()
		{
